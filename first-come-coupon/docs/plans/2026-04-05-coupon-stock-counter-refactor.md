...
- Add tests proving duplicate inserts restore the counter when needed.
...
- If issue insert fails due to duplicate unique constraint, restore stock and propagate the same duplicate semantics.
